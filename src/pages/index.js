...
const IndexPage = ({ data }) => {
  ...
  return (
    <Layout>
            ...
            <>
              <Link className="flex flex-wrap w-full" to={post.fields.slug}>
                ...
                <div className="w-full md:w-1/2 flex justify-center flex-col p-8 px-8">
                  ...
                  <h2 className="text-xl md:text-3xl  font-bold text-gray-900 py-2 hover:text-black">
      ...
      <span className="text-center text-gray-700 text-xl md:text-2xl py-6 pb-2 md:pb-6 font-semibold block">
        Latest Stories
      </span>
      <div className="flex flex-wrap container mx-auto">
        {posts &&
